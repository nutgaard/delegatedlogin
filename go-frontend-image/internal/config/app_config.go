...
func SetupEnv() {
	...
	_ = os.Setenv("DELEGATED_LOGIN_URL", "http://localhost:8082/loginapp/api/start")

	_ = os.Setenv("AUTH_TOKEN_RESOLVER", "loginapp_ID_token")
	_ = os.Setenv("REFRESH_TOKEN_RESOLVER", "loginapp_refresh_token")

	_ = os.Setenv("REFERRER_POLICY", "no-referrer")
	_ = os.Setenv("CSP_DIRECTIVES", "script-src 'self';")
	_ = os.Setenv("CSP_REPORT_ONLY", "true")
