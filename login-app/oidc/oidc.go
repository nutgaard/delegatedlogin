...
func (client Client) OpenAmExchangeAuthCodeForToken(code string, loginurl string) (*TokenExchangeResult, error) {
...
func (client Client) RefreshIdToken(refreshToken string) (*RefreshIdTokenResponse, error) {
	req, err := http.NewRequest(
		"POST",
		client.JwksConfig.TokenEndpoint,
		nil,
...
func CreateOIDC(discoveryUrl, clientId, clientSecret string) (*Client, error) {
